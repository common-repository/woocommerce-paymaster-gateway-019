...
== Changelog ==
= 0.4.4 =
* Критическое обновление: отремонтирован баг с получением статуса заказа "Не удался" при работе планировщика. Продолжение отладки.
= 0.4.3 =
* BugFix статуса отмененных платежей
= 0.4.2 =
* BugFix SSL
= 0.4.1 =
* BugFix кнопки "Оплатить" в браузере Firefox
= 0.4 =
* Поддержка PHP 5.6
= 0.2.01 =
